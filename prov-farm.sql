...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-05-2017 a las 11:27:46
...
(1, 'admin', 'admin', 'admin@gmail.com', '$2y$10$32WM3igW8M4J9geeHryR4eXPhDBQsm3oY8InysEhbGnhPiQ76Lymu', NULL, NULL, NULL),
(2, 'user', 'user', 'user@user.com', '$2y$10$Tie1wwO35WcCP5fiR8KU4OPrc.i147lx4sXEfXOVDceZU.wLEQwHS', NULL, NULL, NULL),
...
--
ALTER TABLE `detalle_salida`
  ADD CONSTRAINT `id` FOREIGN KEY (`id`) REFERENCES `salida` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
